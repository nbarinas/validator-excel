...
# En ClickPanda la app y la BD estan en el mismo servidor, asi que usamos localhost por defecto.
CLICKPANDA_DEFAULT_DB_URL = "mysql+pymysql://zoidusho_az_user:AzMarketing2025*@localhost:3306/zoidusho_az_db"
...
if DATABASE_URL:
    ...
    print("INFO: No se detectó DATABASE_URL. Usando configuracion por defecto de ClickPanda (localhost).")
    SQLALCHEMY_DATABASE_URL = CLICKPANDA_DEFAULT_DB_URL
